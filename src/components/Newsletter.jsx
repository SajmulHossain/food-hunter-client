...
const Newsletter = () => {
  ...
  return (
    <section className="section border rounded border-green-400">
      <div className="max-w-screen-md mx-auto">
        ...
        <div className="mt-6">
          ...
          >
            ...
            />
            <button type="submit" className="w-full mt-3 px-5 py-3 rounded-md text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 duration-150 outline-none shadow-md focus:shadow-none focus:ring-2 ring-offset-2 ring-indigo-600 sm:mt-0 sm:ml-3 sm:w-auto">
              Subscribe
            </button>
          </form>
